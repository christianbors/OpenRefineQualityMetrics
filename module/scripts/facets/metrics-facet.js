...
function MetricsFacet(div, config, options, selection) {
	this._div = div;
	this._config = config;
...
MetricsFacet.reconstruct = function(div, uiState) {
  return new MetricsFacet(div, uiState.c, uiState.o, uiState.s);
};

MetricsFacet.prototype.dispose = function() {
};

MetricsFacet.prototype.reset = function() {
  this._selection = [];
  // attributes
  this._config.detailView;
  this._config.constraints;
};

MetricsFacet.prototype.getUIState = function() {
  var json = {
      c: this.getJSON(),
      o: this._options
  };
...
MetricsFacet.prototype.hasSelection = function() {
...
// MetricsFacet.prototype._copyChoices = function() {
//   var self = this;
...
MetricsFacet.prototype._update = function(resetScroll) {
  var self = this;
...
MetricsFacet.prototype._renderBodyControls = function() {
  var self = this;
...
// MetricsFacet.prototype._getMetaExpression = function() {
...
MetricsFacet.prototype._editChoice = function(choice, choiceDiv) {
  var self = this;
...
MetricsFacet.prototype._reset = function() {
  this._selection = [];
...
MetricsFacet.prototype._invert = function() {
  this._config.invert = !this._config.invert;

  this._updateRest();
};

MetricsFacet.prototype._remove = function() {
...
MetricsFacet.prototype._updateRest = function() {
